...
- 🤖 &nbsp;Product engineering mindset: LLM pipelines, RAG, and voice-agent systems shipped end-to-end, not just prototyped
...
**Open to:** internships and collaborations in AI/ML engineering, full-stack development, and open-source projects.
...
|---|---|---|
| LLM Application Development | Working proficiency | Agentic pipelines and RAG systems built with LangChain and the OpenAI API |
| Retrieval-Augmented Generation | Working proficiency | Vector-store backed retrieval to ground LLM responses in domain-specific data |
| Voice & Conversational AI | Applied experience | Persona-driven voice agents (EduGuardian) using Groq inference over Twilio calls |
| Multilingual NLP | Applied experience | Translation pipelines across Bengali, Hindi, Nepali, Assamese, and English (KothaSetu, WebNew) |
| Prompt Engineering | Working proficiency | Structured and few-shot prompting for reliable, constrained agent behavior |
...
| **Scale** | Single-tenant PWA with Apple Health data ingestion via Shortcuts |
| **Performance** | Registry-based theme engine; SSR/ISR served from Vercel's edge network |
| **Security** | Supabase Auth (OAuth) with row-level security policies |
| **Impact** | An AI performance-coaching OS with a fully designed Indian visual theme |
| **Repository** | [github.com/Dey70/observer-os-web](https://github.com/Dey70/observer-os-web) |

PWA with OAuth, Apple Health ingestion via Shortcuts, and a registry-based theme engine — including a fully designed Indian visual theme.
...
| | |
|---|---|
| **Stack** | React · Node.js · flightapi.io · liteapi.travel |
| **Scale** | Live flight and hotel booking integrations for multilingual travelers |
| **Performance** | Story Design System powering an interactive, investor-facing prototype |
| **Security** | API-key scoped third-party integrations, environment-isolated secrets |
| **Impact** | Bridges the language and travel-planning gap for West Bengal travelers |
| **Repository** | [github.com/Dey70/WB-voice-translator](https://github.com/Dey70/WB-voice-translator) |

Live flight and hotel booking via flightapi.io and liteapi.travel, with a Story Design System and an interactive investor-facing prototype.
...
| | |
|---|---|
| **Stack** | TypeScript · Next.js · LLM content pipelines |
| **Scale** | Full-website translation and localization on the fly |
| **Performance** | LLM-driven pipeline for on-demand page translation |
| **Security** | Isolated LLM API key handling; no persistent storage of translated content |
| **Impact** | Removes the manual localization bottleneck for multi-language site rollout |
| **Repository** | [github.com/Dey70/WebNew-AI-Powered-Website-Translation-Platform](https://github.com/Dey70/WebNew-AI-Powered-Website-Translation-Platform) |

Translates and localizes full websites on the fly using LLM-driven content pipelines.
...
| | |
|---|---|
| **Stack** | Flask · Twilio · Groq |
| **Scale** | Attendance, academic, and behavior risk-tier outreach calling |
| **Performance** | Persona-driven agent backed by low-latency Groq inference for real-time calls |
| **Security** | Twilio-authenticated call flows; no PII retained beyond the call session |
| **Impact** | Multilingual (English, Bengali, Assamese, Nepali) SMS and voice outreach for school parent engagement |
| **Repository** | [github.com/Dey70/EduGuardian-AI-Voice](https://github.com/Dey70/EduGuardian-AI-Voice) |

Attendance, academic, and behavior risk-tier calling with a persona-driven agent and multilingual SMS in English, Bengali, Assamese, and Nepali.
...
<picture>
  ...
  <img alt="contribution snake animation" src="https://raw.githubusercontent.com/Dey70/Dey70/output/dist/snake.svg" width="100%" />
</picture>
